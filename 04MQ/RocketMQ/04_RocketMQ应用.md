...
![image-20220718210907496](assets/image-20220718210907496.png)
...
![image-20220718211808647](assets/image-20220718211808647.png)
...
> 若一条消息在一直消费失败的前提下，将会在正常消费后的第4小时46分后进行第*16*次重试。 若仍然失败，则将消息投递到死信队列 
